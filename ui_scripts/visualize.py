...
# Form implementation generated from reading ui file 'ui/visualize.ui'
#
...
class Ui_Visualise(object):
    def setupUi(self, Visualise):
        ...
        self.select_csv = QtWidgets.QPushButton(Visualise)
        self.select_csv.setGeometry(QtCore.QRect(10, 280, 221, 41))
        ...
        self.select_wav = QtWidgets.QPushButton(Visualise)
        self.select_wav.setGeometry(QtCore.QRect(10, 430, 221, 41))
        self.select_wav.setObjectName("select_wav")
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 600, 221, 31))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(Visualise)
        self.label_6.setGeometry(QtCore.QRect(10, 660, 71, 31))
        self.label_6.setObjectName("label_6")
        self.textEdit_4 = QtWidgets.QTextEdit(Visualise)
        self.textEdit_4.setGeometry(QtCore.QRect(80, 600, 221, 31))
        self.textEdit_4.setObjectName("textEdit_4")
        self.textEdit_5 = QtWidgets.QTextEdit(Visualise)
        self.textEdit_5.setGeometry(QtCore.QRect(80, 660, 221, 31))
        self.textEdit_5.setObjectName("textEdit_5")
        self.pushButton_7 = QtWidgets.QPushButton(Visualise)
        self.pushButton_7.setGeometry(QtCore.QRect(340, 650, 71, 41))
        self.pushButton_7.setObjectName("pushButton_7")
        self.pushButton_8 = QtWidgets.QPushButton(Visualise)
        self.pushButton_8.setGeometry(QtCore.QRect(10, 730, 341, 51))
        self.pushButton_8.setObjectName("pushButton_8")
        self.pushButton = QtWidgets.QPushButton(Visualise)
        self.pushButton.setGeometry(QtCore.QRect(750, 750, 111, 51))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_6 = QtWidgets.QPushButton(Visualise)
        self.pushButton_6.setGeometry(QtCore.QRect(990, 750, 111, 51))
        self.pushButton_6.setObjectName("pushButton_6")
        self.pushButton_9 = QtWidgets.QPushButton(Visualise)
        self.pushButton_9.setGeometry(QtCore.QRect(1230, 750, 111, 51))
        self.pushButton_9.setObjectName("pushButton_9")
        self.label_7 = QtWidgets.QLabel(Visualise)
        self.label_7.setGeometry(QtCore.QRect(750, 710, 141, 31))
        self.label_7.setObjectName("label_7")
        self.graphicsView = PlotWidget(Visualise)
        self.graphicsView.setGeometry(QtCore.QRect(750, 50, 641, 621))
        self.graphicsView.setObjectName("graphicsView")
        self.label_8 = QtWidgets.QLabel(Visualise)
        self.label_8.setGeometry(QtCore.QRect(980, 20, 151, 21))
        font = QtGui.QFont()
        font.setFamily("Academy Engraved LET")
...
""))
        ...
        self.select_csv.setText(_translate("Visualise", "Select CSV File"))
        ...
        self.select_wav.setText(_translate("Visualise", "Select WAV File"))
        ...
        self.pushButton.setText(_translate("Visualise", "Clear"))
        self.pushButton_6.setText(_translate("Visualise", "Save as CSV"))
        self.pushButton_9.setText(_translate("Visualise", "Save as PNG"))
        self.label_7.setText(_translate("Visualise", "Point:"))
        self.label_8.setText(_translate("Visualise", "Valence-Arousal Plot"))
